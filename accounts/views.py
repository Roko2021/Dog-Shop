...
from .serializers import UserRegisterSerializer, LoginSerialiazer, SetNewPasswordSerializer, PasswordResetRequestSerializer
    ...
    def post(self, request):
        ...
        try:
            ...
            if not user.is_verified:
                ...
                user.save()
                return Response({
                   'message': 'account email verifield successfully',
